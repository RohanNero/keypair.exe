...
function create() {
  ...
  console.log(
    `${colors.cyan}${colors.bright}║${colors.reset}${colors.yellow}          KEY GENERATION${colors.cyan}${colors.bright}           ║${colors.reset}`
  );
  console.log(
    `${colors.cyan}${colors.bright}╚═══════════════════════════════════╝${colors.reset}`
  );
  ...
  console.log(
    `   ${colors.magenta}${secp.etc.bytesToHex(compressedPubKey)}${
      colors.reset
    }`
  );
  console.log(
